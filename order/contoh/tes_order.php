    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="dashboard_user.php"><i class="fas fa-home"></i>Home</a>
                </li>
                <li class="nav-item">
            ...
            <div class="card" style="background-color: #DCDCDC">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text" style="color: black">
                        ...
                        <span class="badge <?php echo $row['s_mobil'] === 'Tersedia' ? 'badge-success' : 'badge-danger'; ?>">
                ...
                <div class="card-body">
                    <form method="post" action="../koneksi/proses.php?id=booking">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="lama_sewa" id="lama_sewa" required class="form-control" placeholder="Masukkan Lama Sewa">
                        </div>
                        <!-- Hidden Inputs -->
                        ...
                        <a href="#" class="btn btn-primary btn-block btn-sm">Booking</a>
                    </form>
                </div>
            </div>
        </div>
